...
<section id="insertarSocio" class="container">
    <div class="row py-2">
    <div class="form-body col-12 col-md-6 mx-auto p-5">
     
     <h1>Nueva socio</h1>
     <p>Introduce los datos del nuevo socio</p>
     <form action="../../controladores/controlador_insertar_socio.php" method="POST" id="requires-validation" novalidate>
