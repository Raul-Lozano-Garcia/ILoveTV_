...
<p>
    La titularidad de este sitio web, www.ilovetv.es, (en adelante, Sitio Web) la ostenta: Raúl Lozano García,
    con NIF: 76739116-F, y cuyos datos de contacto son:
</p>
<p>Dirección: C/ San Miguel, Nº28, Churriana de la Vega (Granada)</p>
<p>Teléfono de contacto: 660749247</p>
<p>Email de contacto: rlozanogarcia97@gmail.com</p>
...
<p>
    Blog de series de televisión se reserva la facultad de modificar, en cualquier momento, y sin aviso previo,
    la presentación y configuración del Sitio Web y de los Contenidos y Servicios que en él pudieran estar
    incorporados. El Usuario reconoce y acepta que en cualquier momento Blog de series de televisión pueda
...
<p>
    ...
    los Usuarios, y el Usuario y Blog de series de televisión, como los comentarios y/o espacios de blogging,
    confiere la condición de Usuario, por lo que se aceptan, desde que se inicia la navegación por el Sitio Web,
    todas las Condiciones aquí establecidas, así como sus ulteriores modificaciones, sin perjuicio de la
    aplicación de la correspondiente normativa legal de obligado cumplimiento según el caso. Dada la
    relevancia de lo anterior, se recomienda al Usuario leerlas cada vez que visite el Sitio Web.
</p>
<p>
    El Sitio Web de Blog de series de televisión proporciona gran diversidad de información, servicios y datos.
    El Usuario asume su responsabilidad para realizar un uso correcto del Sitio Web. Esta responsabilidad se
    extenderá a:
</p>
<ul>
    <li>
        Un uso de la información, Contenidos y/o Servicios y datos ofrecidos por Blog de series de televisión
        sin que sea contrario a lo dispuesto por las presentes Condiciones, la Ley, la moral o el orden
        público, o que de cualquier otro modo puedan suponer lesión de los derechos de terceros o del
    ...
    <li>
        ...
        por Blog de series de televisión para el acceso a ciertos Contenidos o Servicios ofrecidos por el Sitio
        Web. En todo caso, el Usuario notificará de forma inmediata a Blog de series de televisión acerca de
        cualquier hecho que permita el uso indebido de la información registrada en dichos formularios,
        tales como, pero no solo, el robo, extravío, o el acceso no autorizado a identificadores y/o
        contraseñas, con el fin de proceder a su inmediata cancelación.
    </li>
</ul>
<p>
    Blog de series de televisión se reserva el derecho de retirar todos aquellos comentarios y aportaciones que
...
<p>
    En cualquier caso, Blog de series de televisión no será responsable de las opiniones vertidas por los
...
<p>
    ...
    Blog de series de televisión y el Usuario.
</p>
<p>
    Siempre en el respeto de la legislación vigente, este Sitio Web de Blog de series de televisión se dirige a
...
<p>
    Blog de series de televisión no garantiza la continuidad, disponibilidad y utilidad del Sitio Web, ni de los
    Contenidos o Servicios. Blog de series de televisión hará todo lo posible por el buen funcionamiento del
...
<p>
    ...
    Usuario. En ningún caso Blog de series de televisión será responsable por las pérdidas, daños o perjuicios
...
<p>
    Blog de series de televisión tampoco se hace responsable de los daños que pudiesen ocasionarse a los
...
<p>
    ...
    Web de Blog de series de televisión deberá saber que:
</p>
<p>
    No se permite la reproducción —total o parcialmente— de ninguno de los Contenidos y/o Servicios del Sitio
    Web sin autorización expresa de Blog de series de televisión.
</p>
<p>
    No se permite tampoco ninguna manifestación falsa, inexacta o incorrecta sobre el Sitio Web de Blog de
    series de televisión, ni sobre los Contenidos y/o Servicios del mismo.
</p>
<p>
    ...
    salvo autorización expresa de Blog de series de televisión.
</p>
<p>
    El establecimiento del hipervínculo no implicará la existencia de relaciones entre Blog de series de
    televisión y el titular del sitio web desde el cual se realice, ni el conocimiento y aceptación de Blog de
    series de televisión de los contenidos, servicios y/o actividades ofrecidos en dicho sitio web, y viceversa.
</p>
<h2>V. PROPIEDAD INTELECTUAL E INDUSTRIAL</h2>
<p>
    Blog de series de televisión por sí o como parte cesionaria, es titular de todos los derechos de propiedad
...
<p>
    ...
    comerciales, en cualquier soporte y por cualquier medio técnico, sin la autorización de Blog de series de
    televisión.
</p>
<p>
    El Usuario se compromete a respetar los derechos de propiedad intelectual e industrial de Blog de series
    de televisión. Podrá visualizar los elementos del Sitio Web o incluso imprimirlos, copiarlos y almacenarlos
...
<p>
    ...
    Blog de series de televisión a través de los datos de contacto del apartado de INFORMACIÓN GENERAL de
...
<p>
    Blog de series de televisión se reserva la facultad de presentar las acciones civiles o penales que
    considere necesarias por la utilización indebida del Sitio Web y Contenidos, o por el incumplimiento de las
    presentes Condiciones.
</p>
<p>
    La relación entre el Usuario y Blog de series de televisión se regirá por la normativa vigente y de
...
<p>
    ...
    generador de plantilla de aviso legal y condiciones de uso online el día 17/02/2022.
</p>
           </div>
       </div>
       ...
       <div class="row p-3">
           <div class="col-12">
               <small class="text-center d-block">Si lo desea, puede descargar toda esta documentación en formato PDF pinchando <a href="../../assets/legal/avisoLegal.pdf" download="Aviso legal ILoveTV.pdf">aquí</a>
</small>
           </div>
       </div>
    </section>
