       ...
       <div class="row">
           <div class="col-12">
               <div class="bg-dark text-light p-5 mb-5">
                    <h1 class="text-center">POLÍTICA DE PRIVACIDAD DEL SITIO WEB</h1>
                    <span class="text-center d-block">www.ilovetv.es</span>
               </div>
               
               <h2>I. POLÍTICA DE PRIVACIDAD Y PROTECCIÓN DE DATOS</h2>
<p>
Respetando lo establecido en la legislación vigente, Blog de series de televisión (en adelante, también
...
<p>
    El responsable del tratamiento de los datos personales recogidos en Blog de series de televisión es: Raúl
    Lozano García, con NIF: 76739116-F (en adelante, Responsable del tratamiento). Sus datos de contacto
    son los siguientes:
</p>
...
<p>
    ...
    recabados por Blog de series de televisión, mediante los formularios extendidos en sus páginas quedarán
    incorporados y serán tratados en nuestro fichero con el fin de poder facilitar, agilizar y cumplir los
    compromisos establecidos entre Blog de series de televisión y el Usuario o el mantenimiento de la relación
    que se establezca en los formularios que este rellene, o para atender una solicitud o consulta del mismo.
</p>
<p>
    Asimismo, de conformidad con lo previsto en el RGPD y la LOPD-GDD, salvo que sea de aplicación la
    excepción prevista en el artículo 30.5 del RGPD, se mantine un registro de actividades de tratamiento que
...
<p>
    Las categorías de datos que se tratan en Blog de series de televisión son únicamente datos identificativos.
...
<p>
    La base legal para el tratamiento de los datos personales es el consentimiento. Blog de series de televisión
    se compromete a recabar el consentimiento expreso y verificable del Usuario para el tratamiento de sus
...
<p>
    Los datos personales son recabados y gestionados por Blog de series de televisión con la finalidad de
...
<p>
    ...
    estadística, y actividades propias del objeto social de Blog de series de televisión, así como para la
...
<p>
    ...
    a la información recopilada.
       ...
       <div class="row p-3">
           <div class="col-12">
               <small class="text-center d-block">Si lo desea, puede descargar toda esta documentación en formato PDF pinchando <a href="../../assets/legal/politicaPrivacidadDatos.pdf" download="Política privacidad ILoveTV.pdf">aquí</a>
</small>
           </div>
       </div>
    </section>
